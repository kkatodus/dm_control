<mujoco model="stretch scene">
  <include file="dm_venv/lib/python3.11/site-packages/dm_control/suite/stretch.xml"/>
  ...
  <worldbody>
	...
	<camera name='forth_person_cam_rgb' pos="-0.038 -1.394 1.406" xyaxes="1.000 -0.011 -0.000 0.007 0.633 0.774"/>
