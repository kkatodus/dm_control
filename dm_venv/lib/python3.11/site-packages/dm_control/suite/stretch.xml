<mujoco model="stretch">
            ...
            <body name="link_arm_l2" pos="0 0 0.013" gravcomp="1">
              ...
              <body name="link_arm_l1" pos="0 0 0.013" gravcomp="1">
                ...
                <body name="link_arm_l0" pos="0 0 -0.01375" quat="1 0 0 0" gravcomp="1">
                  ...
                  <body name="link_wrist_yaw" pos="0.083 -0.03075 0" gravcomp="1">
                    <joint name="joint_wrist_yaw" class="wrist" type="hinge" axis="0 1 0" range='-2 2'/>
					<joint name="joint_wrist_pitch" class="wrist" type="hinge" axis="1 0 0" range='-2 2'/>
					<joint name="joint_wrist_roll" class="wrist" type="hinge" axis="0 0 1" range='-2 2'/>
                    ...
                    <body name="link_gripper_slider" quat="0.183013 -0.683017 -0.683009 -0.183013"
					  ...
					  <body name="realsense_wrist" pos="0.0406 0.0053 0.0307">
						<camera name="camera_rgb_wrist" pos="0 0.015 0" quat=".5 -.5 -.5 .5"/>
						<camera name="camera_depth_wrist" quat=".5 -.5 -.5 .5"/>
					  </body>
      ...
      <body name="link_head_pan" pos="0.00610002 0 1.3552" quat="-1 0 0 0">
        ...
        <body name="link_head_tilt" pos="-0.0013 0.0277625 -0.0533108" quat="1 1 0 0">
          ...
          <body name="realsense" pos="0.0406 0.0053 0.0307">
		   ...
		   <body name="realsense2" pos="0.0406 -0.0053 0.0307">
            <camera name="camera_rgb2" pos="0 0.015 0" quat=".5 .5 .5 .5"/>
            <camera name="camera_depth2" quat=".5 .5 .5 .5"/>
          </body>
        </body>
      </body>
    </body>
  ...
  <actuator>
	...
	<general name="wrist_pitch" joint="joint_wrist_pitch" class="wrist"/>
	<general name="wrist_roll" joint="joint_wrist_roll" class="wrist"/>
