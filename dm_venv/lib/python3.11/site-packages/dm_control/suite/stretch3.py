...
class Test(base.Task):
  ...
  def get_observation(self, physics):
    ...
    obs['forth_person'] = physics.render(camera_id='forth_person_cam_rgb', height=256, width=320)	
    obs['wrist_feed_half'] = physics.render(camera_id='d405_rgb', height=256, width=160)
    obs['head_feed_half'] = physics.render(camera_id='nav_camera_rgb',height=256, width=160)
    obs['forth_person_half'] = physics.render(camera_id='forth_person_cam_rgb', height=256, width=160)
    return obs
